...
| 36  | [#39](https://github.com/izgebayyurt/misket/issues/39) **Code-by-descriptor cross-tab**: codes against descriptor values with counts and click-through, CSV export                                                                                              | The core mixed-methods comparison                      | now    |
| 37  | [#40](https://github.com/izgebayyurt/misket/issues/40) **Query builder**: Boolean and proximity retrieval (A and B, A not B, A near B within a paragraph or N characters), saved queries                                                                        | Retrieval logic every incumbent offers                 | now    |
