...
| 42  | [#45](https://github.com/izgebayyurt/misket/issues/45) **Hierarchy treemap and code clustering** from co-occurrence                                                                                                                                             | Seeing the shape of the codebook                       | next   |
| 43  | [#46](https://github.com/izgebayyurt/misket/issues/46) **OCR fallback for scanned PDFs**, or a clear message when a PDF has no text                                                                                                                             | Users hit format limits mid-import                     | next   |
