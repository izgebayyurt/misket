...
| #   | Feature                                                                                                                                                                                                                                                         | Why it matters                                         | Status |
| --- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------ | ------ |
| 35  | [#38](https://github.com/izgebayyurt/misket/issues/38) **Coding workflow tools**: in vivo coding, quick-code the last code, roll sibling codes up into a parent, "review this code" push-down mode, structured code definitions (inclusion, exclusion, example) | How coders actually work: lump, split, define, revisit | now    |
